...
/**
 * php artisan table-copy:handle  --tableName=table1 --pkColumn=id --startId=0 --finishId=0 --chunkSize=10000  --maxQueries=200 --timeout=5   -v --ignorePk=false
 *
 * php artisan table-copy:handle  -h
 *
 * @package App\Console\Commands
 */
class IncrementalTableCopyCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'table-copy:handle 
     ...
     * @var string
     */
    protected $description = 'Incremental table copy';
...
//        $this->error("Ops, that should not happen.");
        ...
        $itc = new \IncrementalTable\IncrementalTableCopyHandler($this->getDB(), $this);
